...
This layer covers the entire US, so it's a pretty big rater (check with `geom_spatraster()`).
...
Since it's a little unclear where this raster spans geographically, we load a vector dataset of North Carolina counties.
